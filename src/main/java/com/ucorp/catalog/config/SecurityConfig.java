...
import com.ucorp.catalog.filter.JWTAuthProcessingFilter;
import com.ucorp.catalog.filter.UsernamePasswordAuthProcessingFilter;
import com.ucorp.catalog.provider.JWTAuthenticationProvider;
import com.ucorp.catalog.provider.UsernamePasswordAuthProvider;
import com.ucorp.catalog.security.handler.UsernamePasswordAuthFailureHandler;
import com.ucorp.catalog.security.handler.UsernamePasswordAuthSucessHandler;
import com.ucorp.catalog.security.util.JwtTokenFactory;
import com.ucorp.catalog.security.util.SkipPathRequestMatcher;
...
public class SecurityConfig {
	...
	@Bean
	public AuthenticationSuccessHandler usernamePasswordAuthSucessHandler(ObjectMapper objectMapper, JwtTokenFactory jwtTokenFactory) {
	...
	public UsernamePasswordAuthProcessingFilter usernamePasswordAuthProcessingFilter(ObjectMapper objectMapper,
		...
		UsernamePasswordAuthProcessingFilter filter = new UsernamePasswordAuthProcessingFilter(AUTH_URL,objectMapper, authenticationSuccessHandler, authenticationFailureHandler);
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http,
		...
		.sessionManagement(
				(sesionManagement)-> sesionManagement.sessionCreationPolicy(SessionCreationPolicy.STATELESS));

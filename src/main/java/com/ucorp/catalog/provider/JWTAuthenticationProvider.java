package com.ucorp.catalog.provider;
...
public class JWTAuthenticationProvider implements AuthenticationProvider{
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		//1. ambil token jwt nya . getCredential -> rawAccsess
		RawAccsessJwtToken token = (RawAccsessJwtToken) authentication.getCredentials();
		//2.verifikasi dan parsing token
		...
		//3. masukan detailnnya -> userDetails

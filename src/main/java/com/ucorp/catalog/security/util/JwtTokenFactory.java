package com.ucorp.catalog.security.util;
...
public class JwtTokenFactory {
	...
	public AccessJWTToken createAccessJWTToken(String username,Collection<? extends GrantedAuthority> authorities) {
		...
		Date currentTimeDate = Date.from(currentime.atZone(ZoneId.of("Asia/Jakarta")).toInstant());
		// waktu expired token
		LocalDateTime expiredTime = currentime.plusMinutes(15);

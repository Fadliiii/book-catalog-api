...
public class SkipPathRequestMatcher implements RequestMatcher {
	...
	public SkipPathRequestMatcher(List<String> pathSkip, List<String> processingPath) {
		List<RequestMatcher> skip = pathSkip.stream().map(p -> new AntPathRequestMatcher(p))

...
import com.ucorp.catalog.dto.AuthorResponseDTO;import com.ucorp.catalog.dto.AuthorUpdateRequestDTO;
...
//		return ResponseEntity.ok().body(result);
	...
	public ResponseEntity<Void> createNewAuthor(@RequestBody @Valid List<AuthorCreateRequestDto> dtos){
		...
		return ResponseEntity.created(URI.create("/auhtor")).build();
